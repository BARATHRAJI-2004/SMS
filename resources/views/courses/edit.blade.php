                ...
                <form action="{{ route('courses.update', $course->id) }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="text" name="course_code" id="course_code" value="{{ old('course_code', $course->course_code) }}" required class="w-full text-sm border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $course->name) }}" required class="w-full text-sm border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="text" name="teacher_name" id="teacher_name" value="{{ old('teacher_name', $course->teacher_name) }}" required class="w-full text-sm border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="space-y-1">
                                ...
                                <input type="number" name="credits" id="credits" value="{{ old('credits', $course->credits) }}" required min="1" max="6" class="w-full text-sm border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            <div class="space-y-1">
                                ...
                                <input type="number" name="capacity" id="capacity" value="{{ old('capacity', $course->capacity) }}" required min="5" max="100" class="w-full text-sm border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div class="space-y-1">
                        ...
                        <textarea name="description" id="description" rows="4" class="w-full text-sm border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('description', $course->description) }}</textarea>
